                    ...
                    <div class="mail-item-body">
                        <div class="pr-2">
                            ...
                            <?php if($row['is_submit']=='Ya'):?>
                                <span class="mdi mdi-check-circle ml-3 text-warning"></span>&nbsp;<?=$row['kuantitas'];?> Qty Realisasi
                            <?php endif;?></span>
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control bd-0 pd-x-0" name="is_submit" id="entrian-is_submit">
                            <option value="Tidak">Tidak berkaitan</option>
                            <option value="Tidak">Dalam proses</option>
                            <option value="Ya">Sudah selesai</option>
                        </select>
                    </div>
                    <div class="col-sm">Kuantitas</div>
                    <div class="col-sm-4">
                        <input type="text" class="form-control bd-0 pd-x-0" name="kuantitas"  id="kuantitas" value="0">
                    </div>
                </div>
