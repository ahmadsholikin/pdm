        ...
        <form method="POST" action="<?=backend_url();?>/susunan-skp/insert" data-toggle="validator" role="form">
            ...
            <div class="form-row">
                <div class="col form-group">
                    ...
                    <select class="form-control form-control-sm" name="periode_id" type="text" required>
                ...
                <div class="col form-group">
                    ...
                    <select class="form-control form-control-sm" name="link_skp_id" type="text">
                        ...
                        <?php foreach($link as $row_link):?>
                            <option value="<?=$row_link['skp_id'];?>"><?=$row_link['kegiatan'];?></option>
                        <?php endforeach; ?>
                    </select>
                    <div class="help-block with-errors"></div>
                </div>
            ...
            <div class="form-row">
                <div class="col form-group">
                    ...
                    <textarea class="form-control form-control-sm" 
                                name="kegiatan" 
                                id="uraian_kegiatan" 
                                data-error="Entrian ini wajib diisikan"
                                required></textarea>
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            <div class="form-row">
                <div class="col-sm-12 col-md-4 form-group">
                    ...
                    <input class="form-control form-control-sm" 
                            ...
                            type="text" 
                            pattern="^[0-9\./@]{1,}$"
                            data-error="Maaf, entrian hanya berupa angka dan tanda baca titik saja | Wajib diisikan"
                            placeholder="Isikan 0 jika AK tidak ada">
                    <div class="help-block with-errors"></div>
                </div>
                <div class="col-sm-12 col-md-4  form-group">
                ...
                <div class="col-sm-12 col-md-4 form-group">
                    ...
                    <input class="form-control form-control-sm" 
                            name="target_output" 
                            type="text" 
                            placeholder="Dokumen, Laporan, Layanan, Kegiatan" 
                            pattern="^[A-z\s/@]{1,}$"
            ...
            <div class="form-row">
                ...
                <div class="col-sm-12 col-md-3 form-group">
                    <label>Biaya</label>
                    <input class="form-control form-control-sm thousand" 
                            name="target_biaya" 
                            pattern="^[0-9\./@]{1,}$"
                            data-error="Maaf, entrian hanya berupa angka dan tanda baca titik saja | Wajib diisikan"
                            type="text">
