<?php if(!empty(session()->getFlashdata('info_aksi'))):?>
	<div class="alert alert-<?=session()->getFlashdata('info_tipe');?> alert-dismissible d-flex align-items-center mb-3" role="alert">
		<i data-feather="alert-circle" class="mg-r-10"></i>
		<?=session()->getFlashdata('info_aksi');?>
