<div class="card">
	<div class="card-header bg-transparent">
		<a class="text-danger" href="<?=backend_url();?>/konten-berita/add" role="button" data-toggle="tooltip" title="klik untuk menambah data baru" ><i class="mdi mdi-plus-circle"></i> Data Baru</a>
	</div>
	<div class="card-body">
