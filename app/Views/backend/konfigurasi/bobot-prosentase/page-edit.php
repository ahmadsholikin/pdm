<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="<?=backend_url();?>/bobot-prosentase/update" data-toggle="validator" role="form">
            <?= csrf_field() ?>
            <input class="form-control form-control-sm" name="id" type="hidden" readonly required value="<?=$row[0]['id'];?>">
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="col form-group">
                    ...
                    <input class="form-control form-control-sm" 
                            ...
                            data-error="Maaf, entrian hanya berupa angka saja | Wajib diisikan"
                            required 
                            value="<?=$row[0]['bobot_perilaku_kerja'];?>">
                    <div class="help-block with-errors"></div>
                </div>
            </div>
