...
class Users extends BackendController
{
    ...
    public function hapusLink()
    {
        if ($this->request->isAJAX())
        {
            ...
            $link            = $this->LinkHirarkiModel->get(['link_hirarki_id'=>$link_hirarki_id]);
            $used            = $this->PeriodeSKPModel->where('atasan_nip',$link[0]['link_atasan_id'])->orWhere('pejabat_penilai_nip',$link[0]['link_atasan_id'])->orWhere('atasan_pejabat_penilai_nip',$link[0]['link_atasan_id'])->get();
